...
class DataModel(Base):
    ...
    model_grain: Mapped[str | None] = mapped_column(String(300))
    update_strategy: Mapped[str | None] = mapped_column(String(30))
    source_tables: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    source_fqn: Mapped[str | None] = mapped_column(String(500), unique=True, index=True)
